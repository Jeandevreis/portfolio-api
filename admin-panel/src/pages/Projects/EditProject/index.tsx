          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                {t('projects.page.edit.title', { defaultValue: 'Edit Project' })}
              </h1>
              <p className="text-sm text-gray-500">
                {t('projects.page.edit.description', { defaultValue: 'Update your project information.' })}
              </p>
            </div>
            <Link to="/projects" className="text-sm text-gray-600 hover:text-blue-600 font-medium flex items-center gap-1 transition-colors">
              ← {t('projects.buttons.back_to_projects', { defaultValue: '← Back to projects' })}
            </Link>
          </div>

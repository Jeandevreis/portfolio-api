    ...
    <div className="bg-gray-50 text-gray-800 min-h-screen flex flex-col">
      ...
      <main className="flex-1 px-8 py-8 w-full">
        <div className="mb-8">
          ...
          <p className="text-gray-500">O que você gostaria de gerenciar hoje?</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <PanelCard
            ...
            url="/projects"
            title="Meus Projetos"
            description="Gerenciar, editar e adicionar novos projetos ao portfólio."
            icon={
          ...
          <PanelCard
            ...
            description="Gerenciar, editar e adicionar faculdades e cursos ao portfólio."
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <PanelCard
            type="external"
            url="https://willianddaniel.github.io/"
            title="Visualizar Site"
            description="Abrir o site público em uma nova aba."
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
